            ...
            {showSubjectSelect ? (
              <div className="text-center">
                ...
                <div className="d-grid gap-3 col-lg-6 mx-auto mb-4">
                  ...
                  <button
                    className="btn btn-light btn-lg"
                    onClick={() => selectSubject("Psychology")}
                  >
              ...
              <div>
                <h1 className="fw-bold mb-4">NPTEL(MOOC) QUIZ</h1>
                <h1 className="fw-bold mb-4">by ADITYA RAJ</h1>
                {selectedSubject === "Psychology" ? (
                  <h2>Psychology of Learning</h2>
                ) : (
                ...
                <div className="mb-3">
                  {loading ? (
                    ...
                    >
                      ...
                      <option value="Random 20 Questions">
                        Random 20 Questions
                      </option>
                      <option value="All 120 Questions (Jumbled)">
                        All 120 Questions (Jumbled)
                      </option>
